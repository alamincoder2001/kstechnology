...
$route['GenerateBarcode/(:any)'] = 'Administrator/BarcodeController/barcode_create/$1';
...
//order check
$route['order_check'] = 'Administrator/Website/order_check';
$route['get_orders_stock'] = 'Administrator/Website/get_orders_stock';

//Product stock status
$route['product_stock_status'] = 'Administrator/Website/product_stock_status';
$route['get_product_stock_status'] = 'Administrator/Website/get_product_stock_status';
//mother api content
...
$route['sales-entry/(:any)'] = 'Administrator/FSales/index/$1';
$route['fsales/(:any)/(:any)'] = 'Administrator/FSales/salesEdit/$1/$2';
$route['update_fsales'] = 'Administrator/FSales/updateSales';
$route['add_fsales'] = 'Administrator/FSales/addSales';
$route['get_fcustomers'] = 'Administrator/FSales/getCustomers';
$route['sales_record'] = 'Administrator/FSales/false_sales_record';
$route['get_fsales'] = 'Administrator/FSales/getSales';
$route['delete_fsales'] = 'Administrator/FSales/deleteSales';
$route['fsale_invoice_print/(:any)'] = 'Administrator/FSales/saleInvoicePrint/$1';
