        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="sales-entry/product" v-model="access"> False Sales Entry</li>
                    ...
                    <li><input type="checkbox" class="access" value="sales_record" v-model="access"> False Sales Record</li>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="website">
                    ...
                    <li><input type="checkbox" class="access" value="order_check" v-model="access">Order Check </li>
                    <li><input type="checkbox" class="access" value="product_stock_status" v-model="access">Product Stock Status</li>
                </ul>
            </div>
        </div>
    </div>
