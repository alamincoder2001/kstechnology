...
<head>
	...
	<script type="text/javascript">
		function printpage() {
			...
			document.getElementById("printButton").style.cssText = "visibility:hidden;height:0px;margin-top:0px;padding:0px"
...
<body class="">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="output col-md-3 col-md-offset-4">
				<section class="output">
					...
					?>
							...
							<div style="padding: 0px; float: left; height: 68px; width: 94.5px; border: 1px solid #ddd;overflow: hidden;">
								<div style="width: 92px; text-align: center; float: right;">
									<!--<p class="article" style="margin:0px"><?php echo $article; ?></p>-->
									<p style="margin:0px; font-size:10px"><?php echo $article; ?></p>
									<p style="font-size: 10px; text-align: center;margin: -5px 0 0 0;">
										<?php
										if (strlen($pname) > 13) {
											echo substr($pname, 0, 13) . ' .';
										} else {
											echo $pname;
										}
										?></p>
									<img src='<?php echo site_url(); ?>GenerateBarcode/<?php echo $PID; ?>' style="scale:110%;width: 109px;height: 30px;" />
									<p style=" margin: 0px; text-align: center;font-size: 10px;"><?php echo $this->session->userdata('Currency_Name') . ' ' . $Price; ?></p>
								</div>
							</div>
					<?php
						}
