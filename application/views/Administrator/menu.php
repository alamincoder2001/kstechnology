...
<?php } elseif ($module == 'website') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("order_check", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>order_check">
					<i class="menu-icon fa fa-mobile"></i>
					<span class="menu-text">Order Check</span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("product_stock_status", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>product_stock_status">
					<i class="menu-icon fa fa-mobile"></i>
					<span class="menu-text">Product Stock Status </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("sales-entry/product", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>sales-entry/product">
					<i class="menu-icon fa fa-usd"></i>
					<span class="menu-text"> Sales_Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("sales_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>sales_record">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text"> Sales_Record </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
