							...
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">Payment By</label>
												<div class="col-xs-12">
													<select @change="onChangePayment" class="form-control" style="padding:0px 2px;" v-model="sales.payment_type">
									...
									<tr v-if="sales.payment_type != 'Cash'">
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">Account Name</label>
												<div class="col-xs-12">
													<v-select v-bind:options="filteredAccounts" id="account" v-model="selectedAccount" label="display_text" v-on:input="productOnChange"></v-select>
												</div>
											</div>
										</td>
									</tr>
		...
		methods: {
			...
			async getSales() {
				await axios.post('/get_sales', {
					...
					this.selectedCustomer = {
						Customer_SlNo: sales.Customer_SlNo,
